...
//     copyPath(path,folder_path);
//     copyPath(path, "/balasan.config");
...
// void printMatrixChar(MatrixChar m, FILE *f){

// }


// void printAdjMatrix(AdjMatrix m, FILE *f){
